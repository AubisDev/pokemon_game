...
export const colorTypesList = (type: string):TypeData => {
    ...
    switch (type) {
        case 'grass':
            return { 
                bgColor: 'rgb(32,64,0)', 
                bgGradient:'linear-gradient(-45deg, rgba(32,64,0,1) 0%, rgba(62,151,9,1) 31%, rgba(103,247,10,1) 56%, rgba(239,254,231,1) 100%)',
        ...
        case 'fire':
            return {
                ...
                bgGradient:'linear-gradient(45deg, rgba(252,12,11,1) 0%, rgba(246,127,11,1) 31%, rgba(248,184,14,1) 56%, rgba(239,254,231,1) 100%)',
        ...
        case 'water':
            return { 
                bgColor: '#08517a', 
                bgGradient:'linear-gradient(125deg, rgba(8,81,122,1) 0%, rgba(10,122,188,1) 33%, rgba(54,175,246,1) 66%, rgba(239,254,231,1) 100%)',
                weak: ['grass', 'electric'],
        ...
        case 'flying':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(8,87,100,1) 0%, rgba(94,185,178,1) 33%, rgba(220,229,234,1) 66%, rgba(239,254,231,1) 100%)',
        ...
        case 'bug':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(145,186,46,1) 0%, rgba(189,221,110,1) 33%, rgba(217,254,158,1) 66%, rgba(239,254,231,1) 100%)',
        ...
        case 'poison': 
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(97,19,128,1) 0%, rgba(168,25,215,1) 33%, rgba(202,114,236,1) 66%, rgba(239,254,231,1) 100%)',
                weak: ['ground', 'psychic'],
        ...
        case 'electric': 
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(150,145,1,1) 0%, rgba(255,250,36,1) 33%, rgba(247,255,133,1) 66%, rgba(239,254,231,1) 100%)',
                weak: ['ground'],
        ...
        case 'ground':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(191,172,33,1) 0%, rgba(225,209,88,1) 33%, rgba(247,255,133,1) 66%, rgba(239,254,231,1) 100%)',
        ...
        case 'fighting':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(128,11,17,1) 0%, rgba(232,19,25,1) 33%, rgba(211,96,99,1) 66%, rgba(239,254,231,1) 100%)',
        ...
        case 'rock':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(71,64,38,1) 0%, rgba(119,106,62,1) 33%, rgba(180,162,112,1) 66%, rgba(239,254,231,1) 100%)',
        ...
        case 'ice': 
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(12,45,49,1) 0%, rgba(25,149,161,1) 33%, rgba(102,209,229,1) 66%, rgba(220,252,247,1) 100%)',
        ...
        case 'ghost':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(71,43,83,1) 0%, rgba(142,85,164,1) 33%, rgba(189,152,203,1) 66%, rgba(240,230,241,1) 100%)',
                weak: ['ghost', 'dark'],
        ...
        case 'dragon':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(41,3,106,1) 0%, rgba(138,85,253,1) 33%, rgba(214,177,254,1) 66%, rgba(255,255,255,1) 100%)',
        ...
        case 'dark':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(45,34,28,1) 0%, rgba(95,70,50,1) 33%, rgba(145,104,82,1) 66%, rgba(79,79,79,1) 100%)',
        ...
        case 'steel':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(69,69,69,1) 0%, rgba(123,142,138,1) 33%, rgba(187,197,196,1) 66%, rgba(237,239,238,1) 100%)',
                weak: ['fighting', 'ground', 'fire'],
                resistent: ['normal', 'flying', 'rock', 'bug', 'steel', 'grass', 'psychic', 'ice', 'dragon', 'fairy'],
                noAffects: ['poison'],
                symbol: steelSymbol
            }
        ...
        case 'fairy':
            return { 
                ...
                bgGradient:'linear-gradient(125deg, rgba(248,126,167,1) 0%, rgba(255,160,194,1) 33%, rgba(253,209,224,1) 66%, rgba(255,255,255,1) 100%)',
                weak: ['poison', 'steel'],
