...
const Instructions = () => {
  return (
    <Box width={{xs:'90%',sm:'50%'}} height={{xs:'auto',sm:'100%'}} display="flex" alignItems='center' justifyContent="space-evenly">
       <Box  p={{xs:1,sm:1}} mb={{xs:'2em',md:0}}  sx={{background: "rgba(237,239,238,0.95)", borderRadius:"20px", border:"2px solid gray"}}>
        <Typography variant='h5' textAlign='center' color="#444" fontWeight={600} pt={{xs:3,sm:1}} pb={{xs:6,md:0}}  sx={{textDecoration:"underline"}}>Information</Typography>
          <QuestionSection >
