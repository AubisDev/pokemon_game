...
const PokemonSearchBar = () => {
  ...
  return (
    <SearchBarContainer>
        <Form >
        <Typography pb={1} textAlign="left" variant="subtitle1" mt={1}> Search a Pokemon</Typography>
            <TextField
                id="username-input"
                name='username'
        ...
        <Typography textAlign='center' fontSize={12} variant="subtitle2" color="gray" pt={1}>Please make sure to write the name correctly</Typography>
        {
